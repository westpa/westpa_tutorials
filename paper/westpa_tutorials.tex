...
\author[1,\authfn{1}]{Max Dudek}
\author[1,\authfn{1}]{Paul A. Torrillo}
\author[1,\authfn{1}]{Alex J. DeGrave}
\author[2,\authfn{1}]{Upendra Adhikari}
\author[4]{Matthew C. Zwier}
\author[2]{Daniel M. Zuckerman}
\author[1]{and Lillian T. Chong}
\affil[1]{University of Pittsburgh}
\affil[2]{Oregon Health \& Science University}
\affil[3]{Michigan State University}
\affil[4]{Drake University}
...
\contrib[\authfn{1}]{These authors also contributed equally to this work}
